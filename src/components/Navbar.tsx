    ...
    <div className="flex h-full w-[72px] flex-shrink-0 flex-col justify-between border-t border-b border-zinc-600 bg-[#2d2d30]">
      <div>
        <div className="group relative">
          ...
          <span
            className="absolute top-1/2 left-20 z-[20] min-w-max origin-left translate-y-[-50%] scale-0 rounded border-[1px] border-gray-400 bg-[#252526] px-2 py-1.5 text-base text-gray-400 shadow-md transition-all duration-100 before:absolute before:top-1/2 before:-left-3 before:z-[25] before:w-0 before:translate-y-[-50%] before:border-[6px] before:border-solid
        ...
        <div className="group relative">
          ...
          <span
            className="absolute top-1/2 left-20 z-[20] min-w-max origin-left translate-y-[-50%] scale-0 rounded border-[1px] border-gray-400 bg-[#252526] px-2 py-1.5 text-base text-gray-400 shadow-md transition-all duration-100 before:absolute before:top-1/2 before:-left-3 before:w-0 before:translate-y-[-50%] before:border-[6px] before:border-solid before:border-t-transparent before:border-l-transparent before:border-b-transparent before:border-r-gray-400 before:bg-transparent after:absolute after:top-1/2 after:-left-[9.6px]
